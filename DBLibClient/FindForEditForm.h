...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->выходToolStripMenuItem->Size = System::Drawing::Size(54, 19);
			...
			this->вернутс€ЌаЌачальныйЁкранToolStripMenuItem1->Size = System::Drawing::Size(240, 22);
			...
			this->выход»зѕрограммыToolStripMenuItem1->Size = System::Drawing::Size(240, 22);
			...
			this->checkBox1->Text = L" ниги в наличии";
			...
			this->priceColumn->HeaderText = L"÷ена";
